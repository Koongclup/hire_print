...
END as strMonth FROM user_group g where id ='$no'");
    foreach ($query as $r) {
    ?>
            ...
            <div class="sub-page">
                ...
                <table class="b">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <p style="margin-left:10px;">ได้รับเงินค่าตอบแทนรายคาบ เดือน  <b style="margin-left:10px;"> <?= ThDate(); ?></b></p>
                            <p style="margin-left:10px;">จำนวน  <b class="mx-2"><?=$r['workday']?></b> คาบๆละ <b class="mx-2"><?=$r['hire_rate']?> </b>  บาท   
                            <c style="margin-left:140px;">เป็นเงิน</c></p>
                            </br>
                            </br>
                            </br>
                            </br>
                        ...
                        <td>
                            <p align="center" style="margin-top:-7em;"><?= number_format($r['workday']* $r['hire_rate'], 0) ?> </p>
                        </td>
                        <td>
                            <p align="center" style="margin-top:-7em;"> .- </p>
                        </td>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="center"><?= number_format($r['workday']* $r['hire_rate'], 0) ?></td>
                        <td witdh="4%" align="center"> .- </td>
                        <td></td>
                    </tr>
                </table>
                <br>
                <p style="margin-left:60px;">จำนวนเงิน  <b style="margin-left:6em;">( <?php $bath = ($r['workday']* $r['hire_rate']) ; echo Convert($bath); ?> )</b>  </p>
                <br><br>
                <div class="gid">
